...
from qdrant_client.grpc.collections_pb2 import PartialSnapshot
...
#الدمبس بيحول الكلام لاسترنج عن طريق بيفك الديكشنري للسترينج واللودز بترجعها تاني ديكشنري
        return  json.loads(
    ...
    def index_into_vector_db(self, project: Project, chunks: List[DataChunk],
        ...
        vectors = [
            self.embedding_client.set_embed_text(text=text, 
    ...
    def search_vector_db_collection(self, project: Project, text: str, limit: int = 10):
        ...
        vector = self.embedding_client.set_embed_text(text=text, 
